...
with c2:
    ...
    with col100:
        ...
        # st.markdown("Application Tracking System",)
        st.write("\n")
        st.write("\n")
        st.markdown(":blue-background[Click on the image to redirect to the application website.]",)

        # st.image(ats_image,caption="Application Tracking System.",use_container_width=False,)
    with col101:
        st.title("AI based Application Tracking System.")
        st.write("A resume tool based on open source gemini model which give ATS summary, Resume Summarization and Job recommendations.")
        st.markdown("""
        - Description:
            - 1. Developed LLM based system to provide ATS score and what is missing in the resume w.r.t job description.
            - 2. Features AI based Resume Summarizes.
            - 3. Has a Recommendation system to suggest job positions based on ur resume.
        - skills used:
            - python
        ...
        - Tools used:
            ...
            - *render* - (Hosting)
        - Frameworks used:
            - streamlit - Front end website development
            - google-generativeai - to use gemini model
...
""",)
    ...
    with col9:
        ...
        st.markdown(
            ...
            """
            <p>
            <img src="data:image/png;base64,{}" width="350" height="200">
            </p>
            """.format(
                base64.b64encode(open("./foodrecognization.JPG", "rb").read()).decode()
            ),
            unsafe_allow_html=True,
        )
        st.write("\n")
        st.write("\n")
        st.write("Food Recognition and Calorie Counting")
