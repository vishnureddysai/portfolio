...
chatbot_image = Image.open("../portfolio/chatbot.png")
crash_detecttion_image = Image.open("../portfolio/crashdetecttion.png")
databricks_image = Image.open("../portfolio/databricks.png")
azureopenai_image = Image.open("../portfolio/azureopenai2.png")
python_libs_image = Image.open("../portfolio/pythonlibs.png")
profile_image = Image.open("../portfolio/profilepic.jpeg")
aws_sagemaker_image = Image.open("../portfolio/awssagemaker.jpeg")
jupyter_notebook_image = Image.open("../portfolio/jupyternotebook.png")
linkedin_image = Image.open("../portfolio/linkedin_image.jpeg")
agent_image = Image.open("../portfolio/agents_new.jpg",)
foodrecognization_image = Image.open("../portfolio/foodrecognization.jpg",)


with st.sidebar:

    file_ = open("../portfolio/profilepic.jpeg","rb")
    contents = file_.read()
...
with c2:
    ...
    with c21:
        ...
        with open("..\\portfolio\\Resume vishnu masters final.pdf", "rb") as file:
...
""",)
    ...
    with c53:
        ...
        file_ = open("../portfolio/linkedin.gif","rb")
        contents = file_.read()
        data_url = base64.b64encode(contents).decode("utf-8")
        file_.close()
    ...
    with c54:
        ...
        file_ = open("../portfolio/instagram.gif","rb")
        contents = file_.read()
        data_url = base64.b64encode(contents).decode("utf-8")
        file_.close()
    ...
    with c55:
        file_ = open("../portfolio/github.gif","rb")
        contents = file_.read()
        data_url = base64.b64encode(contents).decode("utf-8")
        file_.close()
        st.write("Github!")
    ...
    with c56:
        ...
        file_ = open("../portfolio/mediumweb.gif","rb")
        contents = file_.read()
        data_url = base64.b64encode(contents).decode("utf-8")
        file_.close()
        st.write("Medium!")
